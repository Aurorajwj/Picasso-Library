/*****************************************************
绠€鍗曞疄鐢ㄧ殑jQuery鎻愮ず妗嗙編鍖栨彃浠�(鏀寔alert銆乧onfirm鍜宼oast)
鐗堟湰锛歏1.0
寮€鍙戯細www.fytxsoft.com
******************************************************/
var _fytx_toast_box="";
...
function Fytx_Tips(){
	...
	{		
		...
		var _fytx_alert_background='<div class="fytx_alert_background"><div class="fytx_alert_box">'+'<div class="fytx_alert_title">'+obj.title+'</div>'+'<div class="fytx_alert_message">'+obj.message+'</div>'+'<span class="fytx_alert_btn">确认</span>'+'</div></div>';
	...
	_this.Fytx_confirm=function(obj)
	{
		...
		var _fytx_confirm_background='<div class="fytx_confirm_background"><div class="fytx_confirm_box"><div class="fytx_confirm_title">'+obj.title+'</div><div class="fytx_confirm_message">'+obj.message+'</div><span class="fytx_confirm_okbtn">确认</span><span class="fytx_confirm_cancelbtn">取消</span></div></div>';
